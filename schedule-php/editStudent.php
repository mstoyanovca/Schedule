...
if(isset($_POST["submit"])) {
    ...
    $student = new Student($_POST['first_name'], $_POST['last_name'], $_POST['home_phone'], $_POST['cell_phone'],
                           $_POST['work_phone']);
    $student->edit($_POST['student']);
}
?>
...
<script type="text/javascript" src="js/showStudent.js">
</script>
</head>
...
<div class="container">
    <div class="left">
        <select name="student" id="student" onchange="showStudent(this.value)">
...
<p><input name="submit" type="submit" id="btn" value="Update" disabled=true/>
